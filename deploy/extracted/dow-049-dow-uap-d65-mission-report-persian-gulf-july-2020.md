---
id: "dow-049-dow-uap-d65-mission-report-persian-gulf-july-2020"
...
modal_image_url: "https://www.war.gov/medialink/ufo/release_1/thumbnail/dow-uap-d65-mission-report-persian-gulf-july-2020.jpg"
sha256: "bfbc281190a14c522d854c0cf2699f82de419e8f8a455949871ccdc9175bf423"
bytes: 3043075
pages: 8
...
**Source:** [dow-uap-d65-mission-report-persian-gulf-july-2020.pdf](https://www.war.gov/medialink/ufo/release_1/dow-uap-d65-mission-report-persian-gulf-july-2020.pdf)  
**Pages:** 8  
...
HY AT (04732. ‘OOK OFF FROM OKAS. AT 0504: [ 1.40 | ANDED OVER FROM THE
LRE. FROM 0631Z TO 0050Z ROM 0552Z TO
cond 140 oeeorEl NAVCENT TO OPERATION
GULF, STRAIT OF HORMUZ AND GULF OF OMAN.

A GUARD CALL. SEE GUARD CALL LINE 1. AT 1830]
AERIAL PHENOMENON. SEE OBS LINE 1. AT 19202,
AERIAL PHENOMENON. SEE OBS LINE 2. AT 2345Z,
AERIAL PHENOMENON. SEE OBS LINE 3. AT 0012Z, AS CLEARED TO RTB. AT 0124Z,
14a ANDED BACK TO THE LRE. AT 0200Z; ANDED AT OKAS. FMV WAS

EXPLOITED BY DGS-1, 20.3 MISSION HOURS, 18.3 IMINT HOURS, 1 IMINT TASKING.
PROSECUTED, 18.3] 14a OURS, 1 TASKING PROSECUTED, 2 TOTAL TASKINGS
PROSECUTED
...
+ Full Naas (XG) 1005. 10)6)
* Unit: 482 ATKS

* Wing: 432 AEW

* Phone Number: (3.56 (ox6) |
+ Email: BSc. (be)
¢ Service: Air Force
...
Declassified by MG Richard A. Harris
...
* Time On Station DTG: 160504:00ZJUL26
* Callsign:
¢ JTAR Number: -
...
+ Tasked Start Point: 39RVN3dja@i RA a
...
+ Gentext: om _|coonpnarp WITH NAVCENT 24 HOURS PRIOR
TO TAKE OFF. PRI CTORY. AT 05522 44a ARRIVED ON STATION ISO

NAVCENT TO OPERATION ae 70 CONDUCT SCANS FOR IDENTIFIED

[ta t4g_ WESSELS TO ESTABLISH PATTERN OF LIFE, UAS ACTIVITY AND
CHARACTERIZE ACTIVITY OUTSIDE OF PORTS. FROM 0552Z TO 00124 ONDUCTED
SCANS IAW THE TARGET DECK IN THE ARABIAN GULF (AG). AT ma a | CEIVED A
GUARD CALL. SEE GUARD CALL LINE 1. AT 06452[ 4.43 PBSERVED 1X PROB NASER WAP.
AT 1932Z,] 14a JOBSERVED 1X PROB SAFIR KISH IVO 39RUNGJ[aja Ra MEACING EAST. AT
...
PORT IVO 39RVMagfi Pa ST oorze{ a4 as CLEARED OFF TASKING AND RETURNED
...
+ Gentexts Qu AT 06152 14a }vAS HAILED ON GUARD (b(t) 4a, (oy 1)1.49

 

 

DEFENSE. ORDERS GIVEN: STANDARD CALI INDED WITH THE STANDARD
...
Aircraft Location: 39RXK 36{y1}8{7)1ha
...
Observed Activity Location: I9RVM{W{pi ea ha
...
+ Gentext: [INNS AT 18302Z[ 1.42 JOBSERVED AN UNIDENTIFIED AERIAL PHENOMENON
1VO ORVM {df Bathe
...
Aircraft Callsign; Hei

Aircraft Location; B [ajtha
...
* Observed Activity Location: 39RUN Wig Palatka
* Observed Activity Description: UAP
...
+ Gentext: NINN AT 19202[ 14a [OBSERVED AN UNIDENTIFIED AERTAL PHENOMENON
1VO 39RUN Tf Pea
...
* Asset Type (Aircraf§} fia, (bi(1)1.49

* Aircraft Tail Numbents)1{14a, (b)(4)1.49
...
Aircraft Calisign{ ita

Aircraft Location: 39RUNG@iay Raha 7 |
...
Observed Activity Location: 39RUN@@{ay Raia
...
* Gentext: EB AT 23452] OBSERVED AN UNIDENTIFIED AERIAL PHENOMENON
1VO 39RUNG6234236874

|
Sa

USCENTCOM MDR 26-0028 Approved for Release to AARO - FOUG+PA applies 03/16/26 000007
...
USCENTCOM MDR 26-0028 Approved for Release to AARO - FOUG-+#PA applies 03/16/26 000008
