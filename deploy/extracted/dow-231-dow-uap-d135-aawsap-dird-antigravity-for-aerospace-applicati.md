---
id: "dow-231-dow-uap-d135-aawsap-dird-antigravity-for-aerospace-applicati"
...
incident_date: "3/30/10"
incident_location: "Las Vegas, Nevada"
source_url: "https://www.war.gov/medialink/ufo/sept-18/release-06/assets/DOW-UAP-D135_ AAWSAP-DIRD-Antigravity-for-Aerospace-Applications-March-30-2010-V2.pdf"
modal_image_url: "https://www.war.gov/medialink/ufo/sept-18/release-06/thumbs/DOW-UAP-D135_ AAWSAP-DIRD-Antigravity-for-Aerospace-Applications-March-30-2010-V2.jpg"
sha256: "a97c6847c520fdf7455bfd0d8829df910ac5aeaf6f0f7fb4186c66935ce45a33"
bytes: 58982424
pages: 44
...
**Incident date:** 3/30/10  
**Incident location:** Las Vegas, Nevada  
**Source:** [DOW-UAP-D135_ AAWSAP-DIRD-Antigravity-for-Aerospace-Applications-March-30-2010-V2.pdf](https://www.war.gov/medialink/ufo/sept-18/release-06/assets/DOW-UAP-D135_ AAWSAP-DIRD-Antigravity-for-Aerospace-Applications-March-30-2010-V2.pdf)  
**Pages:** 44  
...
this document should be addressed to lAAP Person 1               I AAWSA Prog ram
...
theoretical poss ibi lity of antigravity also appears in quantum gravity theories,
...
If Earth is chosen to be the larger gravitating mass so that M = M@(5.972 x 10 24 kg),
...
ultradense compact matter, corresponding to dwarf star or neutron star matter ( ~ 10 11
...
ultradense ba ll could be placed near the surface of the Earth and its 1-g gravity field will
...
III. Concepts for Antigravity Within General Relativity
...
which are similar to t he usual centrifugal and Coriolis forces, although much smaller in
...
Likewise, there is an analogy to a magnetic field conta ined within the linearized
...
4
                  UNCLASSIFIED/ /FOA OFFI&il.t.k Y&li 9,.LY

## Page 10

UNCLASSIFIED/ fFOA OFFIEIAk W&i 0Pilk¥

According to Maxwellian electrodynamics, an electric current flowing through a wire that
...
where µo is the vacuum electromagnetic permeability constant (4n x 10- 7 H/m), N is the
...
where rio is the vacuum "gravitational permeability" constant(= 16nG/c2 = 3. 73 x 10- 26
m/kg), 1 N is the total number of turns of pipe wound around the torus, 'ft. is the time
...
field (at the center of the torus) of G ~ 10- 10a acc , where a acc is the acceleration of the
(dwarf star density) matter through the pipes. The tiny factor 10- 10 is composed of the
even smaller rio, which is the reason why very large systems are required to obtain
...
density material within the pipes must achieve a acc = 10 11 m/s 2 in order to accomplish
this effect.
...
1 The vacuum "gravitational permittivity" constant is (Reference 12) : yo= (41tGJ-'   = 1.19 x 109 kg -s2/m 3 •
...
Lense-Thirring effect. Forward's linearization analysis generalizes all of these effects
...
7
                    UNCLASSIFIED/ /FOA OFFI€1.t.k Y&li 8,.LY

## Page 13

UNCLASSIFIED/ fFOA OFFIEIAk W&i 0Pilk¥

The exact relativistic strong-field condition that establishes the lower limit criterion for
vcr;r to induce antigravity repulsion of a payload (as measured by distant inertial
...
In this expression, y = (I - p2)- 112 is the standard relativistic Lorentz transformation factor
which is a function of the normalized relativistic velocity parameter p = vie, 'I'= 'l'(r) = I -
(2GM/rc2) is the goo (or time-time) component of the static Schwarzschild spacetime
...
p (or v) under the condition that a payload far from M, such that r » b (b is the periapsis
distance of the payload from M) and r » GM!c2 , and find that the payload will become
gravitationally repelled by M whenever y2 > 3/2 or p > 3- 112 . In order to derive an exact
...
from it at any v > vcri, , To delineate the propulsion benefit from this technique, Felber
determined that the maximum velocity ( vpmax-wf) that can be imparted to a payload
initially at rest by the weak (gravitationa l) field of a larger source mass moving toward
the payload at constant V > Vcrit is Vpmax-wf « c[P - (3Pt 1]. For the strong-field case, the
maximum velocity (vpma,-,r) that can be imparted to the payload (initially at rest) by the
larger source mass moving toward the payload at any constant v is vpma,-,r = pc. Felber's
...
defined by ds 2 = g""dx 1'dx' , where g," is the metric tensor which is a 4 x4 matrix that encodes the geometry of
spacetime and dx" is the infinitesimal coordinate separation between two points. The Greek indices (µ,v = 0... 3)
denote spacetime coordinates, ><° ... x 3 , such that x 1... x 3 = space coordinates and ><°= time coordinate . The
Schwarzschild metric is: ds 2 = - (1 - 2GM/cir) c2dt 2 + (1 - 2GM/c2r )"1dr2 + r2 (d0 2 + sin 20dcp 2 ) . The corresponding
metric tensor is a diagonal matrix : g,,. = diag[- (1 - 2GM/c2r), (1 - 2GM/c2r)"1, r2, r2sin 2 0). (r, O,cp) are the usual
...
because repulsive force terms are second and higher-order in the source mass velocity.
...
sense that a given (exotic) matter field must have an energy density, PE(= pc 2 , where
...
coord inates, x 1...x 3, indicati ng the spatial components of vector or tensor quantities.
...
Further investigation into this technica l issue showed t hat violations of the energy
cond itions are widespread for all forms of both "reasonable" classical and quantum
...
PE > Pi and/or PE;::,: 0 must be obeyed by all forms of matter in nature is spurious.
...
vehicle. This particular case study will serve as a useful illustrative comparison with the
...
masses. In this case the time-time component of the Ricci curvature tensor (Rµv) is
given by Roo z Gp/c2 z (7.41 x 10- 28 )p m -2 . This is the primary quantity inside the
...
density is 5,500 kg/m 3 so Roo z 4.08 x 10- 24 m- 2 , which indicates that an extremely flat
...
is used, PE*= rest-energy density+ compressional potential energy (a.k.a. pressure),
goo= goo(r) is the time-time component of the metric tensor 8r,v, and Tr(Tµv) = P\, is the
trace (sum of diagonal matrix elements) of the stress-energy-momentum tensor Tµv (a
...
5 The Einstein field equation is:  G". = R". - (1/2)g". R = -(87[G/c:')°fi"'' where G". is the Einstein curvature tensor and
R = R"" (the matrix trace of R". ) is the Ricci scalar curvature. In simplest terms, this relation states that gravity is a
manifestation of the spacetime curvature (G".) induced by a source of matter (T". ).
...
exterior to a ball (or thin spherical shell) of rest-energy density to obtain
 ...
 lv.J-g00 (r)I = G~ = g (acceleration, m/s 2 )                                                 (9)
                     r
...
Since the definition is given that g =   Iv
                                          .J-g00 (r)I, then perform the radial derivative of
...
(9) can be replaced with the negative energy density - pE* = - p c2 = - Mc 2/V by using the
...
energy density), p is t he fluid pressure, u µ is the 4-velocity vector of the fluid, and gµ v is
the metric tensor. The Einstein general relativistic field equation using the identity gµµ =
...
where Gµv is the Einstein curvature tensor. The A term, as it appears in Equation (14),
...
one isotropic tensor of rank 2 that meets this requirement: riµv (the Minkowski flat
...
proportional to ri µv . But this generalizes in a straightforward way from inertial
coordinates to arbitrary coordinates by replacing ri µv with gµv , thus justifying the curved
...
By substituting Equation (19) into Equation (17), one observes that a positive A will act
...
work done by the vacuum pressure -pvac dV dur ing the expansion of space, t herefore /Jvac
...
and ( ordinary and dar k) matt er itemized in t he overall cosmic energy budget. 6 The first
...
15
                       UN CLASSI FIED/ / FOA OFFI€1Ak Yi& 8,.k\f
...
distance). 8 The supernovae data strongly disfavored (with high confidence) the flat
matter-dominated (nm = 1, n /\ = 0) universe and the pure open universe (nm = 0.3, n /\
...
evolution of the general relativistic conservation law for energy, VJ:= V,l ; = O, where
v = 0 to signify time evolution and V r, is the covariant derivative (or spacetime
...
where a is the scale factor of the universe and t& is the time derivative of a. Equation
(20) is derived using Equation (12) in the case of a perfect isotropic fluid where there is
no gravity and velocities are negligible such that u µ = (1, 0, 0, 0), and the energy
...
A cosmological constant corresponds to w"' = wvac = -1, matter (ordinary and dark) to
w mauer ::::: 0, and radiation to W ract = 1/3. 10 The earlier Riess and Perlmutter supernovae

data (fixing the universe to be flat) showed that values of Wcte > - 0.52 for dark energy
...
8 In cosmology, the redshi~ z serves as a surrogate for distance (in light-years) or look-back time.
9 Om =  ratio of energy density contained in matter (as measured today) to the critical energy density; n A = Ovac =
ratio of energy density in a cosmological constant to the critical energy density; Per= 3Hl /8rcG is the critical energy
density, where Ho is the present-day Hubble expansion rate .
10 Non-relativistic (ordinary and dark) matter has a very tiny positive pressure, p oc Temp/m (Temp is absolute

temperature, m is mass), while a relativistic gas (of radiation) hasp = pE/3 > 0.
...
the efficacy of using Type Ia supernovae as a standard distance candle for cosmological
dark energy surveys. The Higher-Z team's results also concluded, with 98 percent
confidence, that wde = - 1.0, and that th is is a perpetual constant (over at least 10 billion
...
energy is the vacuum energy of Einstein's cosmological constant because wdc = wA = -1
(Reference 55,56).

Equation (20) can be integrated to find the evolution of the dark energy density, Pde =
...
where a' is the dummy integration variab le for the scale factor. Since wde = - 1 (= wA ) is
a constant in Equation (22), then Pc,•. oc aexp[-3(1 + ~ 1,)] or Pde = P A oc a0 . This is exactly
what is expected on the basis of previous analysis in Section III-D-2. For a comparison
with this result, one should note that pc2 oc a- 3 for (ordinary and dark) matter and P rn<1 oc
a-4 for radiation such that pc2 ➔ 0 and p,,d ➔ 0 as a ➔ oo while Pde = PA remains constant.
...
answer this question one can use the estimated value for Pde = P A:=:; 2.4poc2 ~ 10-9 J/m 3 ,
where po is the present-day value of the total cosmologica l mass density of (ordinary
...
quantization procedure and order of approximation used in a given quantum gravity
...
procedure for the case of single-photon exchange between two charged particles, which
...
graviton exchange between two massive spin-0 particles in connection with the static
...
graviton -exchange potential, V gr.,v (r), for two spin - 0 particles undergoing a gravitational
...
where m1 and m 2 are the masses of the interacting particles, r is their radial separation,
and 83(r) is the 3-dimensional Dirac 8-function with r the position vector of some
...
term is repulsive. Also, the second term is independent of the interacting particle
masses and can only be measured for bound quantum s-states because the product of
the coefficient 4n(Gli2/c2 ) ~ 10-94 with the 8-function gives only a minute physical effect
...
quantum spin, then Vgrav(r) will be modified by additional spin-orbit and spin-spin
correction terms. Furthermore, there are additional velocity-dependent corrections to
Vgrav(r) that generate the general relativistic post-Newtonian modifications of the
...
affecting bound quantum s-states. In general, quantum gravity correction terms at any
level of approximation, whether gravitationally repulsive or attractive, will have
coefficients ~ G(li0/cK) (for 8, K > 1), and therefore will not have a measurable impact on
...
However, this isn't the entire story because there are many interesting quantum field
...
(or renormalized) stress-energy tensor, ('r,,::         I..,.,
                                                   11 of the quantized vacuum
...
11The angular brackets denote the quantum (vacuum state) expectation value of the stress-energy tensor P ". Also
...
Calloni et al. further point out that a real Casimir cavity is an isolated system in wh ich
...
a gravitational repulsion (FcGexp ) on the Casimir device that is given by (Reference 62):
...
are very small, it appears that FcGexp will be very difficult, if not impossible, to measure
...
suggest SiO2 for the dielectric material because it is an efficient dielectric with low
...
magnify the total force by using Ne = 10 6 layers of rigid cavities with each cavity having
...
modulating F cGexp in order to obtain a measurable force. They are investigating the
possibil ity of modulating ½by varying the temperature in order to induce a periodic
transition from conducting state to superconducting state. They estimate that doing this
could achieve ½max z 0.5, and thus produce a force F cGexp ~ 10- 14 N at a modulation
...
frequency on the order of tens of mHz ford = 5 nm and n = 1.46 (for SiO2 dielectric).
...
fabricate a device consisting of 109 layers, then F coexp 10- 11 N. This suggests that
                                                           IV
...
prescription for (T..:
                    ~),., in a curved spacetime. They also computed the weak
...
The net gravity-induced (electrostatic levitation) self-force (Fo;pGrav ) is given by
(Reference 66):
...
where qe is the electric charge on a particle and r is the radial distance between two
charged particles in the dipole. There is an additional term of order g2/c4 in Fo;porav that is
...
charges (each of rest-mass mo) in a dipole (of mass Mdip = 2mo) such that their
electrostatic potential energy, U d;p = - qe2/4rcEor, becomes equal to the unrenormalized
mass of the system as r ➔ oo . At this distance, the effective total gravitational mass Mct;p
+ Ud;p/c2 = O and the self-force alone can support the dipole at rest against its own weight.
...
renormalized inertial mass of the accelerating system is Mdip-ren =M dir + U ct;p/c2 = 0 and the
...
between two atoms, and          u:;,~
                              is the flat spacetime van der Waa ls (interatom ic potential)
...
single pa ir of interacting atomic dipoles. Item 1 has a two-part contribution to the
...
Item 2 leads to a magnification by factors of a(ro)/ao z 10 3 - 10 5 (ao is the static value of
...
UNCLASSIFIED/ fFOA OFFIEIAL: U&i OPIL:¥

be used to observe this effect in the lab. Pinto also points out that other polarizable
...
lifting force exerted by this element aga inst the external confining fields results in the
...
The propulsive levitation cond ition is expressed as (Reference 66): F1hrus1 = (Mveh + mAN)g or
F1hrus1lmANg ~ 1, where F1hrus1 is the total gravity-induced thrust, M vch is the vehicle mass,
...
within Newtonian gravity theory, General Relativity Theory, sem i-classical quantum
gravity theory, quantum field theory, and nonretarded quantum interatomic dispersion
...
masses and densities, or extreme mass velocities and accelerations. There are other
...
nonlinear gravitational permeability, which could dramatically mitigate such large-scale
...
•    Antigravity via Dipole Gravitational Field Generators: Presently, the technology does
     ...
     moment of the neutrons. The Fermi energy 12 of the bound neutrons limits the
     neutron density to      ~
                           10- 3 kg/m 3 . However, the formation of putative
                   13
     tetraneutrons or the existence of a superconductive-type phase space
     ...
     electromagnetism that the permeability (µ) of magnetic materials such as iron is
...
UNCLASSIFIED/ fFOA OFFIEIAk W&i 0Pilk¥
     ...
     (Reference 14) reported that a rough estimate indicates there is a very small
...
UNCLASSIFIED/ fFOA OFFIEIAk W&i 0Pilk¥
         ...
         adiabatic changes in the boundary conditions of quantum fields, or as classical
     ...
     -   Dirac field states: As described in Section III-C-1, this involves either the
     ...
     -   Quantum coherence effects: Other types of quantum coherence effects not
         ...
         electromagnetic zero-point fluctuations (see items 1 and 3 in Section III-C-1 and
         Appendix A) are not useful forms of negative energy.]

     -   Detecting Negative Energy in the Lab: Reference 70 identified proposals for
         observing negative energy in outer space and in the laboratory, but further work
...
UNCLASSIFIED/ fFOA OFFIEIAk W&i 0Pilk¥
         ...
         geometries, which would provide an understanding of the negative energy
...
•    Antigravity via Nonretarded Quantum lnteratomic Dispersion Force: Pinto's
...
non-negative energy density that is oc E 2 + B 2 , where the electric field (£) and magnetic
...
weaker fluctuations and thus less energy density than the vacuum at locations where
                      =
cos 2 [ro(t - z/c)] 1 and sin 2 [ro(t - z/c)] << 1; but with greater fluctuations and thus
greater energy density than the vacuum at locations where cos 2 [ro (t - z/c)] < < 1 and
sin 2 [ro(t - z/c)] = 1. Since the vacuum is defined to have vanishing energy density, any
...
For the squeezed electromagnetic vacuum state, the energy density P E-sqvac is given by
( Reference 84):


P E-sqvac   = ( 2~(0 } inh ~[sinh ~ + cosh ~cos (2ro(t- z I c) + o)]   (J / m3)        (A.1)


where L 3 is the volume of a large box with sides of length L (that is, put the quantum
                                                              s
...
of squeezing. Equation (A.1) shows that p -sqvac falls below zero once every cycle when
                         s         s
the condition cosh > sinh is met. It turns out that this is always true for every
                        s,
nonzero value of so P E-sqvac becomes negative at some point in the cycle for a general
...
is P E-gsvac = -27r2 hc IA 4 , where "- is the ZPF mode wavelength under consideration in the
...
gravitational squeezing of the vacuum in the laboratory for the purpose of inducing an
...
dimensional spacetime (D = 4) the equation exists A= rc 2/720. To calculate r.,~; for a
given quantum field is to calculate its associated Casim ir effect.
...
boundary conditions and Minkowski spacetime by a manifold of the form m x I (that is,
a product space), where m is the real line defining the time dimension for this particular
...
the generic expression for the energy density is also PcE = -Ahc I d 4 , where
A= ±dr( n 2 I 90), dr is the number of degrees of freedom (for example, helicity states) per
...
only of the base manifold, but of the fiber bundle itself has an effect on  r.~; .
                                                                                 In addition
...
References
[1] Symon, K. R., Mechanics, 3 rd ed., Addison -Wesley Publ. Co., Reading, Mass., 1971,
pp . 10.

[2] Forward, R. L., Future Magic: How Today's Science Fiction Will Become Tomorrow 's
Reality, Avon Books, New York, 1988, pp. 103-132.

[3] Forward, R. L., Indistinguishable From Magic, Baen Publ. Enterpr., Riverdale, New
York, 1995, pp. 148-178.

[ 4] Forward, R. L., "A New Gravitational Field," Science Digest, Vol. 52, 1962, pp . 73-
78.

[5] Forward, R. L., "Far Out Physics," Analog Science Fiction/Science Fact, Vol. 95,
1975, pp. 147- 166.

[6] Davis, E. W., "Advanced Propulsion Study," Air Force Research Laboratory, Final
Report AFRL-PR ED-TR-2004-0024, Air Force Materiel Command, Edwards AFB, CA,
2004, pp. 2-5.

[7] Heaviside, 0., "A Gravitational and Electromagnetic Analogy," The Electrician, Vol.
31, 1893, pp. 281-282, 359.

[8] Thirring, H., "Uber die Wirkung rotierender ferner Massen in der Einsteinschen
Gravitationstheorie," Physikalische Zeitschrift, Vol. 19, 1918, pp. 33-39.

[9] Thirring, H., "Berichtigung zu meiner Arbeit: 'Uber die Wirku ng rotierender ferner
Massen in der Einsteinschen Gravitationstheorie, Physikalische Zeitschrift, Vol. 22,
                                                   111


1921, pp. 29-30.

[10] Thirring, H., and Lense, J., "Uber den Einfluss der Eigenrotation der Zentralkorper
auf die Bewegung der Planeten und Monde nach der Einsteinschen Gravitationstheorie,"
Physikalische Zeitschrift, Vol. 19, 1918, pp. 156-163.

[11) Mashhoon, B., Hehl, F. W., and Theiss, D. S., "On the Gravitational Effects of
Rotating Masses: The Lense-Thirring Papers Translated," General Relativity and
Gravitation, Vol. 16, 1984, pp. 711-750.

[12] Forward, R. L., "Genera l Relativity for the Experimentalist," Proceedings of the
Institute of Radio Engineers, Vol. 49, 1961, pp. 892-904.

[ 13) Forward, R. L., "Antig ravity," Proceedings of the Institute of Radio Engineers, Vol.
49, 1961, p. 1442.

[14) Forward, R. L., "Guidel ines to Antigravity," American Journal of Physics, Vol. 31,
1963, pp. 166-170.

[15) Felber, F. S., "Exact Relativistic 'Antigravity' Propulsion," Proceedings of the STAIF-
2006: 3 rd Symposium on New Frontiers and Future Concepts, edited by M. S. EI-Genk,
AIP Conf. Proc. Vol. 813, AIP Press, New York, 2006, pp. 1374-1381.
...
[16] Misner, C. W., Thorne, K. S., and Wheeler, J. A., Gravitation, W. H. Freeman &
...
[24] Epstein, H., Glaser, V., and Jaffe, A., "Nonpositivity of the Energy Density in
...
[29] Visser, M., "Gravitational vacuum polarization. IV. Energy cond itions in the Unruh
...
[33] Hochberg, D., and Kephart, T. W., "Lorentzian wormholes from the gravitationally
squeezed vacuum," Physics Letters 8, Vol. 268, 1991, pp. 377-383.

[34] DeWitt, B. S., "Quantum Field Theory in Curved Spacetime," Physics Reports, Vol.
19C, 1975, pp. 295-357.

[35] DeWitt, B. S., "Quantum gravity: the new synthesis," General Relativity: An
Einstein Centenary Survey, edited by S. W. Hawking and W. Israel, Cambridge Univ.
Press, Cambridge, 1979, pp. 680-745.

[36] DeWitt, B. S., "The Casimir Effect in Field Theory," Physics in the Making, Essays
on Developments in 20 th Century Physics, In Honour of H. 8. G. Casimir, edited by A.
Sarlemijn and J. Sparnaay, North-Holland Elsevier Science Publ., New York, 1989, pp.
247-272.

[37] Birrell, N. D., and Davies, P. C. W., Quantum fields in curved space, Cambridge
Univ. Press, Cambridge, 1984.

[38] Saunders, S., and Brown, H. R. (eds.), The Philosophy of Vacuum, Clarendon
Press, Oxford, 1991.

[39] Milonni, P. W., The Quantum Vacuum: An Introduction to Quantum
Electrodynamics, Academ ic Press, New York, 1994.

[ 40] Milton, K. A., The Casimir Effect: Physical Manifestations of Zero-Point Energy,
World Scientific, New Jersey, 2001.

[41] Vollick, D. N., "Negative energy density states for the Dirac field in flat spacetime,"
Physical Review D, Vol. 57, 1998, pp. 3484-3488.

[42] Yu, H., and Shu, W., "Quantum states with negative energy density in the Dirac
field and quantum inequalities," Physics Letters 8, Vol. 570, 2003, pp. 123-128.

[43] Alcubierre, M., "The warp drive: hyper-fast travel within general relativity,"
Classical and Quantum Gravity, Vol. 11, 1994, pp. L73-L77.

[44] Olum, K. D., "Superluminal Travel Requires Negative Energies," Physical Review
Letters, Vol. 81, 1998, pp. 3567-3570.

[45] Gao, S., and Wald, R. M., "Theorems on gravitational time delay and related
issues," Classical and Quantum Gravity, Vol. 17, 2000, pp. 4999-5008.

[46] Morris, M. S., Thorne, K. S., and Yurtsever, U., "Wormholes, time machines, and
the weak energy conditions," Physical Review Letters, Vol. 61, 1988, pp. 1446-1449.

[47] Ford, L. H., "Quantum coherence effects and the second law of thermodynamics,"
Proceedings of the Royal Society of London. Series A, Mathematical and Physical
Sciences, Vol. 364, 1978, pp. 227-236.

[ 48] Davies, P. C. W., "Can moving mirrors violate the second law of
thermodynamics?," Physics Letters 8, Vol. 11, 1982, p. 215.
...
[ 49] Everett, A. E., "Warp drive and causality," Physical Review D, Vol. 53, 1996, pp.
7365-7368.

[50] Terletskii, Ya. P., Paradoxes In The Theory of Relativity, Plenum Press, New York,
1968, Chap. VI.

[51] Peacock, J. A., Cosmological Physics, Cambridge Univ. Press, Cambridge, 1999,
pp. 25-26.

[52] Riess, A. G., et al., "Observational Evidence from Supernovae for an Accelerating
Universe and a Cosmological Constant," Astronomical Journal, Vol. 116, 1998, pp.
1009-1038.

[53] Perlmutter, S., et al., "Measurements of n and A from 42 High-Redshift
Supernovae," Astrophysical Journal, Vol. 517, 1999, pp. 565-586.

[54] Schwarzschild, B., "High-redshift supernovae indicate that dark energy has been
billion years," Physics Today, Vol. 60, 2007, pp. 21-25.

[55] Riess, A. G., et al., "New Hubble Space Telescope Discoveries of Type Ia
Supernovae at z ; :,: 1: Narrowing Constraints on the Early Behavior of Dark Energy,"
Astrophysical Journal, Vol. 659, 2007, pp. 98-121.

[56] Astier, P., et al., "The Supernova Legacy Survey: measurement of !1M, Q A and w
from the first year data set," Astronomy and Astrophysics, Vol. 447, 2006, pp. 31-48.

[57] Particle Data Group, "Review of Particle Physics," Journal of Physics G: Nuclear and
Particle Physics, Vol. 33, 2006, pp. 210-232.

[58] Feynman, R. P., and Hibbs, A. R., Quantum Mechanics and Path Integrals,
McGraw-Hill Book Co., New York, 1965.

[59] Feynman, R. P., Morinigo, F. B., and Wagner, W. G., Feynman Lectures on
Gravitation, edited by B. Hatfield, Addison-Wesley Publ. Co., Reading, MA, 1995.

[60] Zee, A., Quantum Field Theory In A Nutshell, Princeton Univ. Press, Princeton,
2003, Chap. VIIl.1.

[61] Calloni, E., et al., "Gravitational effects on a rigid Casimir cavity," International
Journal of Modern Physics A, Vol. 17, 2002, pp. 804-807.

[62] Calloni, E., et al., "Vacuum fluctuation force on a rigid Casimir cavity in a
gravitational field," Physics Letters A, Vol. 297, 2002, pp. 328-333.

[63] Bimonte, G., et al., "Novel features of the energy-momentum tensor of a Casimir
apparatus in a weak gravitational field," Journal of Physics A: Mathematical and
Theoretical, Vol. 41, 2008, 164056.

[64] Bimonte, G., et al., "Energy-momentum tensor for a Casimir apparatus in a weak
gravitational field," Physical Review D, Vol. 74, 2006, 085011.

[65] Bimonte, G., et al., "Erratum: Energy-momentum tensor for a Casimir apparatus
...
[66] Pinto, F., "Progress in Quantum Vacuum Engineering Propulsion," Journal of the
British Interplanetary Society, Vol. 59, 2006, pp. 247-256.

[67] Fermi, E., "Sull'elettrostatica di un campo gravitazionale uniforme e sul peso delle
masse elettromagnetiche," Nuovo Cimento, Vol. 22, 1921, pp. 176-188.

[68] Puthoff, H. E., "Polarizable-Vacuum (PV) Approach to General Relativity,"
Foundations of Physics, Vol. 32, 2002, pp. 927-943.

[69] Hathaway, G. D., "Chapter 5: Gravitational Experiments with Superconductors:
History and Lessons," Frontiers of Propulsion Science, Progress in Astronautics and
Aeronautics Series, Vol. 227, eds. M. G. Millis and E.W. Davis, AIAA Press, Reston, VA,
2009, pp. 229-248.

[70] Davis, E. W., "Chapter 15: Faster-than-Light Approaches in General Relativity,"
Frontiers of Propulsion Science, Progress in Astronautics and Aeronautics Series, Vol.
227, eds. M. G. Millis and E. W. Davis, AIAA Press, Reston, VA, 2009, pp. 473-509.

[71] Rabeau, J. R., et al., "Fabrication of single nickel-nitrogen defects in diamond by
chemical vapor deposition," Cornell Univ. Library arXiv.org e-Print Archive, URL:
http://arxiv.org/cond-mat/0411245.pdf (cited 11 April 2004).

[72] Rabeau, J. R., et al., "Diamond chemical vapor deposition on optical fibers for
fluorescence waveguiding," Cornell Univ. Library arXiv.org e-Print Archive, URL:
http ://arxiv.org/cond-mat/0411249.pdf (cited 11 April 2004).

[73] Ries, J., Brezger, B., and Lvovsky, A. I., "Experimental vacuum squeezing in
rubidium vapor via self-rotation," Physical Review A, Vol. 68, 2003, 025801.

[74] Agnesi, A., et al., "MIR status report: an experiment for the measurement of the
dynamical Casimir effect," Journal of Physics A: Mathematical and Theoretical, Vol. 41,
2008, 164024.

[75] Brownell, J. H., Kim, W. J., and Onofrio, R., "Modelling superradiant amplification
of Casimir photons in very low dissipation cavities," Journal of Physics A: Mathematical
and Theoretical, Vol. 41, 2008, 164026.

[76] Marecki, P., "Balanced homodyne detectors and Casim ir energy densities, " Journal
of Physics A: Mathematical and Theoretical, Vol. 41, 2008, 164037.

[77] Drummond, P. D., and Ficek, Z. (eds.), Quantum Squeezing, Springer-Verlag,
Berlin, 2004.

[78] Slusher, R. E., et al., "Observation of Squeezed States Generated by Four-Wave
Mixing in an Optical Cavity," Physical Review Letters, Vol. 55, 1985, pp. 2409-2412.

[79] Slusher, R. E., and Yurke, B., "Squeezed Light," Scientific American, Vol. 254,
1986, pp. 50-56.

[80] Robinson, A. L., "Bell Labs Generates Squeezed Light," Science, Vol. 230, 1985,
pp. 927-929.
...
[81] Robinson, A. L., "Now Four Laboratories Have Squeezed Light," Science, Vol. 233,
1986, pp. 280-281.

[82] Saleh, B. E. A., and Teich, M. C., Fundamentals of Photonics, Wiley Series in Pure
and Applied Optics, John Wiley & Sons, Inc., New York, 1991, pp. 414-416.

[83] Caves, C. M., "Quantum-mechanical noise in an interferometer," Physical Review
D, Vol. 23, 1981, pp. 1693-1708.

[84] Pfenning, M. J., "Quantum Inequality Restrictions on Negative Energy Densities in
Curved Spacetimes," Ph.D. Dissertation, Dept. of Physics and Astronomy, Tufts Univ.,
Medford, MA, 1998.

[85] Casimir, H. B. G., "On the Attraction Between Two Perfectly Conducting Plates,"
Proc. Kon. Ned. Akad. Wetensch., Vol. 51, 1948, pp. 793-796.

[86] Lamoreaux, S. K., "Demonstration of the Casimir Force in the 0.6 to 6 µm Range,"
Physical Review Letters, Vol. 78, 1997, pp. 5-8.

[87] Mohideen, U., "Precision Measurement of the Casimir Force from 0.1 to 0.9 µm,"
Physical Review Letters, Vol. 81, 1998, pp. 4549-4552.

[88] Chen, F., et al., "Theory confronts experiment in the Casimir force measurements:
Quantification of errors and precision," Physical Review A, Vol. 69, 2004, 022117.

[89] Brown, L. S., and Maclay, G. J., "Vacuum Stress between Conducting Plates: An
Image Solution," Physical Review, Vol. 184, 1969, pp. 1272-1279.

[90] Walker, W. R., "Negative energy fluxes and moving mirrors in curved space,"
Classical and Quantum Gravity, Vol. 2, 1985, pp. L37-L40.

[91] Moore, G. T., "Quantum Theory of the Electromagnetic Field in a Variable-Length
