---
id: "dow-047-dow-uap-d63-mission-report-strait-of-hormuz-october-2020"
...
| eclassified by MG Richard A. Har

USCENTCOM Chief of Staf

see Declassified on: 16 Mar

Misrep 4871281

Narrative

MS AT 22492] 1.42 [TOOK OFF FROM OKAS. AT 23002|_14a_ANDED OVER FROM THE
LRE. FROM 2338Z TO 08252, 14a FROM 1319Z TO
1essz{SS~—™—sa SSS~S~SC*&ROMOITZ TO 1835Z]_ 1.40
SUPPORTED NAVCENT FOR OPERATION|  yituda VO ARABIAN GULF, STRAIT
OF HORMUZ AND GULF OF OMAN. SEE ISR LINE |. AT 0727Z[ 4.42 RECEIVED A
GUARDCALL. SEE GUARDCALL LINE 1. AT 0854Z[ 14a RECEIVED A GUARD CALL. SEE
GUARDCALL LINE 2. AT 11222, IRECEIVED A GUARD CALL. SEE GUARDCALL LINE 3.

AT 12362|_ 14a RECEIVED A GUARD CALL. SEE GUARD Leng AT 1315Z[_142_]
...
OBSERVATION LINE 1. AT 1835Z|_14a WAS CLEARED TO RTB. AT 19222, ANDED
BACK TO THE LRE. AT 1953Z[ 7,42 [LANDED AT OKAS. FMV WAS EXPLOITED BY DGS-1. 21
...
* Full Namego,_(b}), 1306, bis)

+ Unit: 482 ATKS

* Wing: 432 AEW

* Phone Number: [“35c (pve) |
...
* Phone Number: ["35c, (by6) |

© Email: CSCS SGN SCC™C~C—CSCSCSCOCCC.
...
+ Full Namgx§, (bya), 1306, (616)

¢ Unit: 609 AOC ISRD Unit Support

* Wing: Other

* Phone Number: (35c (pie) |
...
USCENTCOM MDR 26-0028 Approved for Release to AARO- FOUG/ PA applies 03/16/26 000003
...
Asset Type (Aircraf(jifi4a_(bd)1.49
Aircraft Tail Numbenga)4 ff 4a, (6)(4)1.4g
...
eclassified by MG Richard A. Harris
USCENTCOM Chief of Staf

SS Declassified on: 16 Mar
...
+ BE Number (if NTISR): - |
* Tasked Start Point: 39RWK7@{ai RAG a
...
TO TAKE OFF. PRECOORD WAS SATISFACTORY, AT 01172, RRIVED ON STATION ISO
NAVCENT FOR OPERATION [____gaqyt.da __]' 0 CHARACTERIZE IRIN\IRGCN VESSELS,
UAS ACTIVITY, ACTIVITY OUTSIDE OF PORTS, AND TO ESTABLISH PATTERN OF LIFE.
FROM 0117Z TO 1835Z,| 1.42 (CONDUCTED SCANS IAW THE TARGET DECK IN THE
ARABIAN GULF (AG). AT 1244Z,| 4.44 |OBSERVED 1X UI AIRCRAFT ON RUNWAY AT ABU
MUSA ISLAND AIRFIELD. AT 1344Z] 1.42 DBSERVED TXU/I AIRCRAFT AT ABU MUSA
ISLAND AIRFIELD ASSESSED TO BE AN ATR 72-500. AT 1657Z,[ 14a OBSERVED 1X POSS
NASER WAP DOCKED IVO BUSHERH IRIN BOATYARD. AT 0727Z! 14a RECEIVED A GUARD
CALL. SEE GUARDCALL LINE L. AT 0854Z[ 14a RECEIVED A GUARD CALL. SEE
GUARDCALL LINE 2. AT 11222] 1.4a RECEIVED A GUARD CALL. SEE GUARDCALL LINE 3.
AT 12362, 1.42 [RECEIVED A GUARD CALL, SEE GUARDCALL LINE 4. AT 18352, AS
...
+ Supported Operation: OPERATION [pda]
* Precoord Time: 24 HOURS
« Precoord Effectiveness: SATISFACTORY

WEATHER
* Weather: (U) HEAVY HAZE PRECLUDED IJMINT ANALYSIS
...
USCENTCOM MDR 26-0028 Approved for Release to AARO- FO¥O+PA applies 03/16/26 000005
T
...
Ground Station Cailsign:
Aircraft Location: 40RCP 7 RAC Ka
...
* Gentext: GQ AT 07272 +40 | WAS HAILED ON GUARD (b}(1)1.4a, (b)(1)1.4g
DEFENSE. ORDERS GIVEN: STANDARD CALL[ 14a RESPONDED WITH STANDARD
...
* Ground Station Callsign: 1.43

 

 

* Aircraft Location: 40RDP (LOLA Ka
...
+ Gentext: EJ AT 08542. ‘AS HAILED ON GUARD (b)(1)1.4a, (b)(1)1.4g
DEFENSE. ORDERS GIVEN: DARD CALL, RESPONDED WITH STANDARD
...
¢ Ground Station Callsig Lttatag |

+ Aircraft Location: 40RCQ (ian kai ha
...
GENTEXT/GUARDCALL
* Gentext: INNNNN AT 1122z[ 142 |WAS HAILED ON GUARD

DEFENSE. ORDERS GIVEN: STANDARD CALI[ 1.42 RESPONDED WITH STANDARD
RESPONSE 1. NO IMPACT TO THE MISSION
...
* Aircraft Callsign: | aaa

* Ground Station Callsig :
+ Aircraft Location: 40RCP3ifay Rai ka
...
* Gentext: (SYREL AT 1236Z. [4S HAILED ON GUARD (y(t) 4a, (OX 1)1.4g
...
GUARDCALL
+ GUARDCALL DTG; 021315:00ZO0CT20

* Aircraft Callsign

+ Ground Station Ga @§— ae
* Aircraft Location: 40RCP@ Rca
...
* Gentext: [NNN AT 13152] 14a }VAS HAILED ON GUARD (Pt) 4a, (BI(1)1.4a

DEFENSE. ORDERS GIVEN: STANDARD CALL] 4.44 SPONDED WITH STANDARD
RESPONSE 1. NO IMPACT TO THE MISSION
